...
enum TipoRegistroEnum {
  ...
  static final Map<String, TipoRegistroEnum> _findByNome = Map.fromEntries(
    TipoRegistroEnum.values.map((value) => MapEntry(value.nome, value)),
  );

  static final Map<int, TipoRegistroEnum> _findByPosicao = Map.fromEntries(
    TipoRegistroEnum.values.map((value) => MapEntry(value.posicao, value)),
  );
